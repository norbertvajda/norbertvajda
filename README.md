...
I have 12+ years expertise with PHP (vanilla PHP, various frameworks and CMS systems), vanilla JavaScript and CSS, while I started to learn Laravel (v5.4) in 2017.
...
* Laravel (^12)
* Livewire (^3.6)
* Filament (^4.0 for CMS-like projects)
* JavaScript (vanilla, Modern ES6+), AlpineJS
* CSS3, SCSS Preprocessor, Tailwind
* MySQL, MariaSQL, PostgreSQL and SQLite - Database planing, architecture and optimization
